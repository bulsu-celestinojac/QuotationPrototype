...
// 1. Check database for the highest 'ADD' number ever used
...
// 2. Check the incoming parsed items (just in case the PDF/Excel naturally had an 'ADD' mark)
