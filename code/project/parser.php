...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: 'DM Sans', sans-serif; background: linear-gradient(135deg, #F8F6F5 0%, #FAFAF9 100%); color: var(--text-main); padding: 40px 30px; min-height: 100vh; overflow-x: hidden; }
        ...
        .card { background: var(--surface); border-radius: 24px; padding: 40px 48px; border: 1px solid var(--border); margin-bottom: 32px; box-shadow: 0 12px 40px rgba(42,8,8,0.04); transition: transform 0.3s ease; width: 100%; }
        ...
        .file-drop-area { border: 2px dashed var(--border); border-radius: 16px; padding: 60px 24px; text-align: center; background: var(--surface); cursor: pointer; transition: all 0.3s ease; position: relative; overflow: hidden; display: flex; align-items: center; justify-content: center; flex-direction: column; margin-bottom: 32px; width: 100%; }
        ...
        .alert { padding: 16px 24px; border-radius: 12px; font-size: 0.9rem; font-weight: 700; margin-bottom: 32px; text-align: center; width: 100%; }
        ...
        .extracted-card { padding: 24px 0 0 0; overflow: hidden; background: var(--surface); border-radius: 24px; border: 1px solid var(--border); box-shadow: 0 12px 40px rgba(42,8,8,0.04); width: 100%; }
        ...
        .table-container { width: 100%; overflow-x: auto; max-height: 650px; overflow-y: auto; border-radius: 0 0 24px 24px; -webkit-overflow-scrolling: touch; }
        table { width: 100%; border-collapse: collapse; text-align: center; position: relative; min-width: 600px; } 
        ...
        @media (max-width: 768px) {
            ...
            .card { padding: 24px 20px; border-radius: 16px; max-width: 100%; }
            .file-drop-area { padding: 40px 16px; max-width: 100%; box-sizing: border-box; }
            .file-msg { font-size: 1rem; }
            .btn-submit { max-width: 100%; height: 50px; font-size: 0.95rem; }
            
            .extracted-card { max-width: 100%; border-radius: 16px; }
            .extracted-header { flex-direction: column; align-items: flex-start !important; gap: 16px; padding: 20px !important; }
            .extracted-footer { padding: 24px 20px !important; text-align: center !important; }
            .extracted-footer .btn-submit { width: 100%; padding: 0; }

            .table-container { width: 100%; max-width: 100vw; box-sizing: border-box; }
...
<body>
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 32px; width: 100%;">
            ...
            <?php if (!empty($extractedData)): ?>
                <!-- Action goes to the local project_form.php -->
                <form action="project_form.php" method="POST" style="width: 100%; max-width: 100%;">
