...
<body>
        ...
        <form method="post" enctype="multipart/form-data" id="machineForm" autocomplete="off">
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="file-drop-area" id="pdf-drop-area" style="min-height: 80px; padding: 20px;">
                        <span class="file-msg" id="pdf-file-msg">Browse or drop a PDF document here</span>
   ...
   <script>
        ...
        // File Selection/Drop logic for Image
        ...
        pdfInput.addEventListener('change', function() {
            if (this.files && this.files.length > 0) {
                ...
                pdfMsg.innerHTML = '📄 <strong>' + this.files[0].name + '</strong> selected';
            } else {
                pdfDropArea.classList.remove('is-active');
                pdfMsg.textContent = 'Browse or drop a PDF document here';
            }
        });
