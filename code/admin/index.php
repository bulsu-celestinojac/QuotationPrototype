...
// A. Quotes (Simplified to avoid missing user_id column error)
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* INVENTORY APPROVAL CARDS (Ported from approvals.php) */
                    ...
                    <div class="table-responsive">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="font-weight: 700; color: var(--text-main);"><?php echo htmlspecialchars($p['project_name'], ENT_QUOTES, 'UTF-8'); ?></div>
